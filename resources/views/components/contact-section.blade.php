<section id="contact" class="relative py-24 bg-white border-t border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <div class="space-y-6">
                    {{-- Email --}}
                    <a href="mailto:daocheick383@gmail.com" class="group flex items-center gap-4 p-4 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900 group-hover:text-blue-600 transition-colors">daocheick383@gmail.com</p>
                        </div>
                    </a>
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        ...
                        <div class="flex gap-4">
                            <a href="https://github.com/CheickDAOKA" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-gray-50 text-gray-600 hover:bg-gray-900 hover:text-white transition-all shadow-sm hover:shadow-md" aria-label="GitHub">
                            ...
                            <a href="https://www.linkedin.com/in/cheick-dao-29b588371/" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-gray-50 text-gray-600 hover:bg-blue-600 hover:text-white transition-all shadow-sm hover:shadow-md" aria-label="LinkedIn">
...
<footer class="bg-gray-50 py-8 border-t border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <p class="text-sm font-medium text-gray-500">
            &copy; {{ date('Y') }} Cheick Abdoul Kader DAO. Tous droits réservés.
        </p>
        <p class="text-xs text-gray-400 mt-2">
            Créé avec Laravel, Livewire & Tailwind CSS
        </p>
    </div>
</footer>
