    ...
    <header class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center gap-8 text-base font-medium">
                <a href="#accueil" class="uppercase tracking-widest transition-colors hover:text-blue-600" :class="scrolled ? 'text-gray-600' : 'text-gray-700'">Accueil</a>
                <a href="#competences" class="uppercase tracking-widest transition-colors hover:text-blue-600" :class="scrolled ? 'text-gray-600' : 'text-gray-700'">Compétences</a>
                <a href="#parcours" class="uppercase tracking-widest transition-colors hover:text-blue-600" :class="scrolled ? 'text-gray-600' : 'text-gray-700'">Parcours</a>
                <a href="#projets" class="uppercase tracking-widest transition-colors hover:text-blue-600" :class="scrolled ? 'text-gray-600' : 'text-gray-700'">Projets</a>
                <a href="#contact" class="uppercase tracking-widest transition-colors hover:text-blue-600" :class="scrolled ? 'text-gray-600' : 'text-gray-700'">Contact</a>
            </nav>
            ...
            <div class="flex items-center gap-3">
                ...
                >
                    ...
                    <svg x-show="$root.dark" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
            <a href="#accueil" @click="mobileOpen = false" class="px-4 py-3 rounded-lg text-gray-700 font-medium uppercase tracking-widest hover:bg-gray-50 transition-colors">Accueil</a>
            <a href="#competences" @click="mobileOpen = false" class="px-4 py-3 rounded-lg text-gray-700 font-medium uppercase tracking-widest hover:bg-gray-50 transition-colors">Compétences</a>
            <a href="#parcours" @click="mobileOpen = false" class="px-4 py-3 rounded-lg text-gray-700 font-medium uppercase tracking-widest hover:bg-gray-50 transition-colors">Parcours</a>
            <a href="#projets" @click="mobileOpen = false" class="px-4 py-3 rounded-lg text-gray-700 font-medium uppercase tracking-widest hover:bg-gray-50 transition-colors">Projets</a>
